...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{TESTAPPOPENID_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{TESTAPPOPENID_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
testappopenid_server.pl - Catalyst Testserver

=head1 SYNOPSIS

testappopenid_server.pl [options]
